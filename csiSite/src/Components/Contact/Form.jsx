...
export default function Form({ title }) {
	return (
		<div
			className={`rounded-3xl  flex justify-center flex-col items-center w-full md:w-1/2 mx-auto py-10 px-1 sm:px-5 my-10`}
		>
			...
			>
				...
				<div className='w-full'>
					<textarea
						className='w-full outline-gray-950 outline outline-2 rounded-md px-2 py-1 text-gray-800 font-medium'
